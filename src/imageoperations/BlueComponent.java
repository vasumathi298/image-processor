 ...
 */
public class BlueComponent implements ImageOperationController {
   ...
   */
  public BlueComponent(String input) {
  ...
  public void performOperation(ImageProcessingModel imageProcessingModel) {
    try {
      ...
      imageProcessingModel.blueComponent(instruction[1], instruction[2]);
    } catch (Exception e) {
