 ...
 */
public class GreenComponent implements ImageOperationController {
   ...
   */
  public GreenComponent(String input) {
  ...
  public void performOperation(ImageProcessingModel imageProcessingModel) {
    try {
      ...
      imageProcessingModel.greenComponent(instruction[1], instruction[2]);
    } catch (Exception e) {
