...
/**
 * Test cases for enhanced image manupulations and operations.
 */
public class TestEnhancedImageManipulations {
  ...
  @Test
  public void testImageColorCorrection20() throws Exception {
    String input = "load output/manhattan-small.png manhattan-small\n"
            + "compress 20 manhattan-small manhattan-small-compressed-20\n"
            + "save manhattan-small-compressed-20.png manhattan-small-compress-img";
    ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
    System.setIn(in);
    ImageProcessingModel model = new ImageProcessingModelImpl();
    ImageProcessingController controller = new ImageProcessingControllerImpl(in, model);
    controller.imageOperationSelector();
    RGB[][] image = model.retrieveImage("manhattan-small-compressed-20");
    assertTrue(image.length > 0);
  }


  @Test
  public void testImageHistogramFor20() throws Exception {
    String input = "load output/manhattan-small-compressed-20.png manhattan-small\n"
            + "histogram manhattan-small manhattan-small-compressed-20-histogram";
    ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
    System.setIn(in);
    ImageProcessingModel model = new ImageProcessingModelImpl();
    ImageProcessingController controller = new ImageProcessingControllerImpl(in, model);
  ...
  @Test
  public void testImageColorCorrection60() throws Exception {
    String input = "load output/manhattan-small.png manhattan-small\n"
            + "compress 60 manhattan-small manhattan-small-compressed-60\n"
            + "save manhattan-small-compressed-60.png manhattan-small-compress-img";
    ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
    System.setIn(in);
    ImageProcessingModel model = new ImageProcessingModelImpl();
    ImageProcessingController controller = new ImageProcessingControllerImpl(in, model);
    controller.imageOperationSelector();
    RGB[][] image = model.retrieveImage("manhattan-small-compressed-60");
    assertTrue(image.length > 0);
    assertNotNull(controller);
  }
  ...
  @Test
  public void testImageHistogramFor60() throws Exception {
    String input = "load output/manhattan-small-compressed-60.png manhattan-small\n"
            + "histogram manhattan-small manhattan-small-compressed-60-histogram";
    ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
    System.setIn(in);
    ImageProcessingModel model = new ImageProcessingModelImpl();
    ImageProcessingController controller = new ImageProcessingControllerImpl(in, model);
  ...
  @Test
  public void testImageColorCorrection90() throws Exception {
    String input = "load output/manhattan-small.png manhattan-small\n"
            + "compress 90 manhattan-small manhattan-small-compressed-90\n"
            + "save manhattan-small-compressed-90.png manhattan-small-compress-img";
    ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
    System.setIn(in);
    ImageProcessingModel model = new ImageProcessingModelImpl();
    ImageProcessingController controller = new ImageProcessingControllerImpl(in, model);
    controller.imageOperationSelector();
    RGB[][] image = model.retrieveImage("manhattan-small-compressed-90");
    assertTrue(image.length > 0);
  }
  ...
  public void testLevelAdjustmentSplit() throws Exception {
    String input = "load output/manhattan-small.png manhattan-small\n"
            + "levels-adjust 20 100 255 manhattan-small manhattan-small-level-adjust-split "
            + "split 60\n"
  ...
  public void testHistogramForLevelAdjustedImage1() throws Exception {
    String input = "load manhattan-small-level-adjust-threshold.png manhattan-small-level-adjust\n"
            + "histogram manhattan-small-level-adjust manhattan-small-level-adjust-"
            + "threshold-histogram";
    ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
    System.setIn(in);
    ImageProcessingModel model = new ImageProcessingModelImpl();
  ...
  public void testLumaComponentSplit() throws Exception {
    String input = "load output/manhattan-small.png manhattan-small\n"
            + "greyscale luma-component manhattan-small manhattan-small-luma-split-"
            + "component split 35\n"
  ...
  public void testIntensityComponent() throws Exception {
    String input = "load output/manhattan-small.png manhattan-small\n"
            ...
            + "save manhattan-small-intensity-component.png manhattan-small-"
